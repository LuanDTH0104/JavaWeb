<%-- 
    ...
    Created on : 11-Mar-2023, 22:16:33
...
<html>
    <head>
        ...
        <title>Boppee - Thông tin người dùng</title>
    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <div>${requestScope.customerInfor[1]}</div>
            ...
            <div class="tag"><a href="<%=request.getContextPath()%>/customer-profile">Chỉnh sửa hồ sơ</a></div>
        ...
        <div id="content">
            ...
            <hr>
            <span class="part-tag">Tên đăng nhập</span>
            <div class="seller-infor">${requestScope.customerInfor[5]}</div><br>
            <span class="part-tag">Mật khẩu</span>
            <input type="password" value="${requestScope.customerInfor[6]}" disabled class="seller-infor"><span id="change-password">Thay đổi mật khẩu</span><br><br>
            <span class="part-tag">Họ và tên</span>
            <div class="seller-infor">${requestScope.customerInfor[1]}</div><br>
            <span class="part-tag">Số điện thoại</span>
            <div class="seller-infor">${requestScope.customerInfor[2]}</div><br>
            <span class="part-tag">Giới tính</span>
            <div class="seller-infor">${requestScope.customerInfor[3] eq "male" ? "Nam" : "Nữ"}</div><br>
            <span class="part-tag">Ngày sinh</span>
            <div class="seller-infor">${requestScope.customerInfor[4]}</div>
        </div>

            <form id="infor-form" action="<%=request.getContextPath()%>/customer-infor" method="POST">
            <!-- The Modal -->
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#infor-form").submit(function (event) {
                ...
                } else if ($('#password').val() != ${requestScope.customerInfor[6]}) {
