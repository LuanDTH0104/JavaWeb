...
<html>
    ...
    <body>
        <a href="<%=request.getContextPath()%>/page" style="text-decoration: none;"><h5 id="header" >Chỉnh sửa thông tin</h5></a>
        <div id="sidebar">
        ...
        <form action="<%=request.getContextPath()%>/sellerprofile" method="post">
            <div class="content-container">
                <div class="login-content">
                    ...
                    <div class="input-part">
                        <div>Tên</div>
                        <input type="text" name="name" id="" value="${requestScope.sellerInfor[1]}">
                    </div>
                    <div class="input-part">
                        <div>Tên cửa hàng</div>
                        <input type="text" name="store-name" id="" value="${requestScope.sellerInfor[2]}">
                    </div>
                    <div class="input-part">
                        <div>Số điện thoại</div>
                        <input type="tel" name="phone-number" id="" value="${requestScope.sellerInfor[3]}">
                    </div>
                    <div class="input-part">
                        <div>Giới tính</div>
