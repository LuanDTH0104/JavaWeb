            ...
            if (action == null || action.equals("")) {
                for (Cookie cookie : cookies) {
                    if (cookie.getName().contains("cart")) {
                        ...
                        order.add(new Cart(Integer.parseInt(cookie.getValue()), Integer.parseInt(quantity)));
                        Object[] object = pd.getProductByProductId(Integer.parseInt(cookie.getValue()));
                        object[object.length - 1] = Integer.parseInt(quantity);
                        products.add(object);
                    }
                }
                ...
                Object[] object = pd.getProductByProductId(Integer.parseInt(proId));
                object[object.length - 1] = Integer.parseInt(quantity);
                products.add(object);
            }
