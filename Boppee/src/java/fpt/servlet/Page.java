...
public class Page extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<Date,Integer> hash = a.getTotalOrderIn7days();
        HashMap<Date,Integer> income = a.getTotalIncomeIn7days();
        HashMap<Date,Integer> average = a.getAverageIncomeIn7days();
        request.setAttribute("totalOrders", hash);
