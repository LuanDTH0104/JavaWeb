 ...
 */
@WebServlet(name = "CustomerInfor", urlPatterns = {"/customer-infor"})
public class CustomerInfor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CustomerInfor</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CustomerInfor at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cad.updatePassword(newPassword, (Integer) session.getAttribute("customerId"))) {
