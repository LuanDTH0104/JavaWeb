...
<body>
    <div class="container-fluid heading">
        <img src="" alt="">
        <a href="<%=request.getContextPath()%>/page" target="target" style="text-decoration: none; color: white"><h5>Chỉnh sửa sản phẩm</h5></a>
    </div>
            ...
            <div class="col-8 right-content">
                <form action="<%=request.getContextPath()%>/edit" method="post" 
                    ...
                    <div class="parts">
                        ...
                        <img id="product-photo" src="${requestScope.productInfor[0].toString()}" alt="alt"/>
                        <div id="product-img-input" class="img-class">Thay đổi hình ảnh</div>
                        <input type="file" name="img-input" id="fileinput" accept="image/*" hidden value="${requestScope.productInfor[0].toString()}" onchange="previewFile()">
                    </div>
                    <div class="parts">
                        <div class="img-class">Tên sản phẩm</div>
                        <div class="img-class"><input type="text" name="product-name" id="product-name-input" value="${requestScope.productInfor[1]}"></div>
                    </div>
                    <div class="parts">
                        <div class="img-class">Giá sản phẩm</div>
                        <div class="img-class"><input type="number" name="product-price" id="product-name-input" value="${requestScope.productInfor[2]}"></div>
                    </div>
                    <div class="parts">
                        <div class="img-class">Ngành hàng</div>
                        <div class="img-class">
                            <select name="categories-classify" id="categories-name-input">
                                <option value="${requestScope.productInfor[4]}" selected hidden>${requestScope.productInfor[5]}</option>
                    ...
                    <div class="parts" id="last-parts">
                        ...
                        <div class="img-class"><textarea name="product-describe" id="product-describe-input" cols="30"
                                rows="10">${requestScope.productInfor[3]}</textarea></div>
                    </div>
